    ...
    <div className="w-[100%] h-[60px] bg-white grid grid-cols-2 lg:grid-cols-3">
      <div className="w-full h-[60px]">
        <ul className="w-full h-full flex items-center">
          ...
          <li className="inline-block text-[35px] p-[10px] rounded-xl hover:bg-[#6ba4e9] hover:text-white h-[55px]">
            {/* <AiOutlineMessage /> */}
            <ToggleChat />
          </li>
        </ul>
      ...
      <div className="lg:block lg:w-full lg:h-[60px] lg:p-[7px] hidden">
        <div className="border border-black flex items-stretch w-[500px] h-[45px] p-[5px] rounded-xl">
          <input
            type="text"
            placeholder="Search"
            className="w-[450px] h-[35px] pl-[10px] focus:outline-0"
          />
          <label className="text-3xl p-[3px]">
            <BiSearchAlt2 />
          </label>
        </div>
      </div>
