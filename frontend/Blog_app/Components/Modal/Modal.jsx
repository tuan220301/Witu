...
const Modal = ({ isShowing, hide, title, data, listControl, option }) =>
  isShowing
            ...
            {option === 0 ? (
              <div>
                ...
                <div className="modal-wrapper" aria-modal aria-hidden tabIndex={-1} role="dialog">
                  <div className="modal bg-white dark:bg-black text-black dark:text-[#fafafa] border border-[#fafafa] shadow-lg dark:border-[#5557]">
